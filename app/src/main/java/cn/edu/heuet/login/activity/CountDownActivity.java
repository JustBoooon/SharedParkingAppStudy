...
public class CountDownActivity extends BaseActivity {
    ...
    private void checkToJump() {
        ...
        // 非首次打开，登录回调判断
            ...
            if (isLogin) {
                //如果已经登录了，就跳转到主页
                startActivity(new Intent(CountDownActivity.this, MainActivityPast.class));
            } else {
                //未登录，跳转到登录页
    ...
    private void asyncValidate(final String account, final String password) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final String telephone = account;  // 为了让键和值名字相同，把account改成了telephone，没其他意思
